...
def build_huffman_tree(txt):
    ...
    # и сохраняет его в словаре
    freq = {i: txt.count(i) for i in set(txt)}

    # Создает приоритетную очередь для хранения активных узлов дерева Хаффмана.
